...
export const achievements = [
  { title: "Runner-up — International Blockchain Olympiad", year: "2019 · Hong Kong" },
  { title: "Champion — 6th Tsinghua Entrepreneurship Competition, Blockchain", year: "2019 · Hsinchu" },
  { title: "Runner-up — BTSC Youth Innovation & Entrepreneurship Competition", year: "2019 · Taichung" },
